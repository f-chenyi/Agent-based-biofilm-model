...
double A_0 = E_0 * R /1000.0; 	// cell-cell adhesion energy, equals to PI*gamma_12
...
const double dtTHRESH = 1e-6*h0;

// Time evolution parameters and output:
const double T = 5.0; // Integrate for this amount of total time.
...
my6Vec cell_cell_gforce(int i, int j) {
    ...
    if (typei[1] == 'W' or typej[1] == 'W') // at least one cell is WT. use JKR model
    {
